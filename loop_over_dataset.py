...
## 3d object detection
import student.object_detection_pcl as pcl
import student.object_detection_detect as det
import student.object_detection_eval as eval
...
from student.track_management import TrackManagement
...
configs_det.use_labels_as_objects = False  # True = use ground truth labels as objects, False = use model-based detection
...
if 'show_tracks' in exec_list:
    fig, (ax2, ax) = plt.subplots(1, 2, figsize=(24, 20),constrained_layout=True)
